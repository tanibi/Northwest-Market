            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot doc : task.getResult()) {
                        ...
                        if (doc.getString("category").equals("books")) {
                    ...
                    productLayoutManager = new LinearLayoutManager( Books.this);
                    productsAdapter = new ClothingProductsAdapter(itemListArray, Books.this);
