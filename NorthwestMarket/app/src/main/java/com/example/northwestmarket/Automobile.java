            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot doc : task.getResult()) {
                        ...
                        if (doc.getString("category").equals("automobile")) {
                    ...
                    productLayoutManager = new LinearLayoutManager(Automobile.this);
                    productsAdapter = new ClothingProductsAdapter(itemListArray, Automobile.this);
