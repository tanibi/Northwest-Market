            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot doc : task.getResult()) {
                        ...
                        if (doc.getString("category").equals("footwear")) {
                    ...
                    productLayoutManager = new LinearLayoutManager(Footwear.this);
                    productsAdapter = new ClothingProductsAdapter(itemListArray, Footwear.this);
