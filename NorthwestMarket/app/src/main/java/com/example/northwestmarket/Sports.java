            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot doc : task.getResult()) {
                        ...
                        if (doc.getString("category").equals("sports")) {
                    ...
                    productLayoutManager = new LinearLayoutManager(Sports.this);
                    productsAdapter = new ClothingProductsAdapter(itemListArray, Sports.this);
